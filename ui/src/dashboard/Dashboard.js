...
export default function Dashboard() {
  ...
  const [gcloudData, setGcloudData] = React.useState('projects')
  const showProjects = () => {
    setGcloudData('projects')
  }
  const showClusters = () => {
    setGcloudData('clusters')
  }
  const showBuckets = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <div>
        <ListItem onClick={showProjects} button>
          <ListItemIcon>
            <AccountTreeIcon />
          </ListItemIcon>
          <ListItemText primary="Projects" />
        </ListItem>
        <ListItem onClick={showBuckets} button>
          <ListItemIcon>
            <StorageIcon />
          </ListItemIcon>
          <ListItemText primary="Buckets" />
        </ListItem>
        <ListItem onClick={showClusters} button>
          <ListItemIcon>
            <ViewQuiltIcon />
          </ListItemIcon>
